...
~~~sh
# getting the code
git clone git@github.com:nko4/struggler.git && cd ./struggler/

# developing
npm install
npm start

# deploying (to http://struggler.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@struggler.2013.nodeknockout.com
ssh root@struggler.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@struggler.2013.nodeknockout.com
ssh -i ./id_deploy root@struggler.2013.nodeknockout.com
~~~
